        ...
        <div class="flex justify-center mb-20">
            <div class="flex flex-row h-64 px-10">
                ...
                <div class="flex flex-col justify-center">
                    <p class="text-center text-lg max-w-lg p-10">🌿 1. Kies de juiste planten<br>Een jungletuin begint met groen, veel groen! Kies voor planten met grote, tropisch ogende bladeren zoals bananenplanten, hosta’s, varens of bamboe. Combineer dit met kleurrijke bloemen zoals lelies of hibiscus om een exotische sfeer te creëren. Hoe meer variatie in vorm en bladstructuur, hoe natuurlijker het oogt.</p>
                </div>
            </div>
        </div>
